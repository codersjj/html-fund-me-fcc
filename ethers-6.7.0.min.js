...
function parseUnits$1(value, unit) {
  ...
  return FixedNumber.fromString(value, { decimals: decimals, width: 512 }).value
}
...
class RIPEMD160 extends SHA2 {
  ...
  process(view, offset) {
    ...
    for (let group = 0; group < 5; group++) {
      ...
      for (let i = 0; i < 16; i++) {
        const tl =
          (rotl$1(al + f(group, bl, cl, dl) + BUF[rl[i]] + hbl, sl[i]) + el) | 0
...
var nodeCrypto = Object.freeze({ __proto__: null, default: _nodeResolve_empty })
const _0n = BigInt(0)
const _1n = BigInt(1)
const _2n = BigInt(2)
const _3n = BigInt(3)
...
class EventLog extends Log {
  ...
  constructor(log, iface, fragment) {
    ...
    defineProperties(this, { args: args, fragment: fragment, interface: iface })
  }
  get eventName() {
...
class BaseContract {
  ...
  constructor(target, abi, runner, _deployTx) {
    ...
    defineProperties(this, { target: target, runner: runner, interface: iface })
...
class EnsResolver {
  ...
  constructor(provider, address, name) {
    defineProperties(this, { provider: provider, address: address, name: name })
...
class AbstractProvider {
  ...
  _setTimeout(_func, timeout) {
    ...
    if (this.paused) {
      ...
      this.#timers.set(timerId, { timer: timer, func: func, time: getTime$1() })
    }
    return timerId
  }
